...
function IconPropertyGuru({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      version="1.2"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1508 1510"
      width="1508"
      height="1510"
      fill="currentColor"
      className={cn('h-4 w-4 bg-white', className)}
      {...props}
    >
